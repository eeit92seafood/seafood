...
public class ArticleDAOJdbc implements ArticleDAO {
	...
	private static final String INSERT = "insert into article (memberId,articleData,articlePeople,articleTotalStar,articleAverageStar,articleTitle,memberNicknName,cutData) values (?,?,?,?,?,?,?,?)";
	@Override
	public ArticleBean insert(ArticleBean bean) {
		...
		try (Connection conn = dataSource.getConnection(); PreparedStatement stmt = conn.prepareStatement(INSERT);) {
			...
			if (bean != null) {
				...
				stmt.setInt(4, bean.getArticleTotalStar());
				stmt.setInt(5, bean.getArticleAverageStar());
	...
	private static final String UPDATE="update article set articleTitle=?, articleData=?,memberNicknName=?,cutData=? where articleId=?";
	@Override
	public ArticleBean update(int articleId,String articleTitle, String articleData,String memberNicknName,String cutData) {
