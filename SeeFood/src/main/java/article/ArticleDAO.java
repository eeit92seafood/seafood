...
public interface ArticleDAO {
	...
	ArticleBean insert(ArticleBean bean); // 會員新增文章
	
	ArticleBean update(int articleId,String articleTitle,String articleData,String memberNicknName,String cutData);  // 會員修改文章
